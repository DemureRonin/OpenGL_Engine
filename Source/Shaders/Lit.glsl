...
void main()
{
	...
	vec4 albedo = texture(material.albedo, interpolators.UV);
	vec4 specularMap = texture(material.specular, interpolators.UV);
	vec3 result = CalcDirLight(directionalLight, norm, viewDir, specularMap, albedo);
